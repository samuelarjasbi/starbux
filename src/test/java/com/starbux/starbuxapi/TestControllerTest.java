...
public class TestControllerTest extends StarbuxapiApplicationTests {
    ...
    public void GetUserAccessTest() throws Exception {
    ...
    @Test
    @WithMockUser(username = "username", roles={"MODERATOR"})
    public void GetModeratorAccessTest() throws Exception {
    ...
    public void GetAdminAccessTest() throws Exception {
